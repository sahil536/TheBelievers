...
<div class="inner">
					...
					<!-- Boxes -->
						...
						<c:forEach items="${shows}" var="shows" end="23">
						 <div class="box">
								<a href="seasons/showId=${shows.id}" class="image fit"><img src="${shows.midimage}" alt="" /></a>
								<div class="inner">
									<h3>${shows.name}</h3>
									<p>${shows.summary}</p>
								</div>
								<a href="seasons?showId=${shows.id}" class="button style2 fit" data-poptrox="youtube,800x400">Seasons And Episodes</a>
							</div>
